...
| Rerun validation report after Appendix A update | ✅ Done (2026-05-11) | Validation re-run completed; v1.0.2 pre_activation pattern (PM-10a–PM-10d) and v1.0.3 CTR-012 threat detection changes verified in `security-architecture-spec-validation.md` |
