...
# Usage:
#   imports:
#     - uses: shared/repo-mind-light.md
#       with:
#         config-yaml: |
...
#
# Important: gh-aw imports are repository-local. To use this from another repo,
# vendor this file into that repository at .github/workflows/shared/repo-mind-light.md.
