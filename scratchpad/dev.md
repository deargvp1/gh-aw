...
- [Sentry OTEL Dashboard Specification](./sentry-otel-dashboard-spec.md) - OTEL-first Sentry dashboard and alert model for `gh-aw.job.conclusion` spans: runtime health, cost, risk, firewall, rate-limit, and write-activity views
...
- v8.6 (2026-05-07): Added `sentry-otel-dashboard-spec.md` documenting the OTEL-first Sentry dashboard baseline for `gh-aw.job.conclusion` spans: field map, dashboard set, alert thresholds, and the current gap for audit-derived assessment labels. Added 1 new Related Documentation link. Coverage: 65 spec files (1 new).
